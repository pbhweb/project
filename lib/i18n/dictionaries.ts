...
export const dictionaries = {
  en: {
    ...
    cta_subtitle: "Join business owners, freelancers, and affiliates already using WorkHub.",
  ...
  ar: {
    ...
    features_title: "لماذا تختار WorkHub",
    ...
    cta_subtitle: "انضم إلى أصحاب الأعمال والمستقلين والمسوقين على منصة WorkHub.",
