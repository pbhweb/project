...
import { FreelancerLicenseUpload } from "@/components/freelancer-license-upload";
    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          {profile?.role === "freelancer" && profile?.id && (
            <div className="mt-6">
              <FreelancerLicenseUpload freelancerId={profile.id} />
            </div>
          )}
        </div>
      </main>
