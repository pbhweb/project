                  ...
                  <Alert>
                    <AlertDescription className="text-sm space-y-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-xs">
                        {profile?.role === "freelancer" && <li>يظهر رقمك لصاحب العمل فقط عند قبول عرضك على المشروع</li>}
                        {profile?.role === "business_owner" && <li>يظهر رقمك للمستقل فقط عند قبول عرضه على مشروعك</li>}
                        {profile?.role === "affiliate" && <li>رقمك محمي ولن يظهر لأي شخص</li>}
                        <li>لا يمكن وضع أرقام الهواتف في أوصاف المشاريع أو العروض</li>
                      </ul>
                    </AlertDescription>
                  </Alert>
                </div>
