...
const termsData = [
  ...
  },
  {
    ...
    content: [
      ...
      "في حال كان المشروع مسجلاً عبر كود إحالة مسوق، تُخصم عمولة إضافية قدرها 10% من قيمة المشروع الأصلية.",
      "تُحسب عمولة المسوق من الميزانية الدنيا للمشروع قبل خصم أي عمولات أخرى.",
