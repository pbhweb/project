...
const termsData = [
  ...
  },
  {
    ...
    content: [
      ...
      "المنصة ليست طرفاً في الاتفاقيات بين أصحاب العمل والمستقلين والمسوقين.",
    ],
  },
   {
    id: 5,
    ...
    content: [
      "يحصل المستقل على 20% ثابتاً من قيمة العرض النهائية المتفق عليها.",
      "تتقاضى المنصة عمولة قدرها 80% من قيمة العرض عند عدم وجود كود إحالة.",
      "في حال كان المشروع مسجلاً عبر كود إحالة مسوق، يتم توزيع قيمة العرض كالتالي: المنصة تحصل على 70%، والمسوق يحصل على 10%، والمستقل يحصل على 20%.",
      "يتم دفع عمولة المسوق بعد قبول العرض النهائي وتسديد الدفعة من قبل صاحب العمل.",
      "تتم عملية الدفع النهائية بين صاحب العمل والمستقل بعد الاتفاق على العرض وخصم جميع العمولات المستحقة.",
      "جميع الأسعار المعروضة على المنصة تكون شاملة ضريبة القيمة المضافة إن وجدت.",
      "المنصة لا تتحمل مسؤولية أي نزاعات مالية بين الأطراف.",
    ],
  },
  {
    id: 6,
