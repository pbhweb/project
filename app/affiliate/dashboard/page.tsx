...
الدفع يتم من طرف ثالث (Gumroad) بشكل آلي بالكامل 
    ...
    <ul className="list-decimal list-inside text-sm space-y-1 text-neutral-300">
      ...
      <li>
        تواصل معنا على{" "}
        <a href="mailto:affiliate@workshub.space" className="underline font-medium text-white hover:text-neutral-200">
